...
public class TestAuthor {
	...
	public void testFixDefectiveFirstName() {
		Author author1 = new Author("Kofia, Victor (UNIV TORONTO)",
				Category.INCITES);
		Author author2 = new Author("Kofia, Vica (UNIV TORONTO)",
				Category.INCITES);
		Author check = null;
		...
		if (check != null) {
			fixed = author2.getFirstName().equalsIgnoreCase(
	...
	public void testFixFirstName() {
		...
		check = authorMap.get(author1);
		if (check != null) {
			switched = author2.getFirstName().equalsIgnoreCase(
					author1.getFirstName());
		}
		assertTrue(switched);
	}
	...
	public void testIdentifyAuthorWithDefectiveFirstName() {
		Author author1 = new Author("Kofia, Victor (UNIV TORONTO)",
				Category.INCITES);
		Author author2 = new Author("Kofia, Victro (UNIV TORONTO)",
				Category.INCITES);
		Author author3 = null;
		HashMap<Author, Author> authorMap = new HashMap<Author, Author>();
		authorMap.put(author2, author2);
		...
		if (author3 != null) {
			authorIdentified = author3.equals(author1)
					&& author3.equals(author2);
		}
	...
	public void testIdentifyAuthorWithOnlyFirstInitialB() {
		...
		Author author2 = new Author("Kofia, Victor (UNIV TORONTO)",
				Category.INCITES);
		Author author3 = null;
		HashMap<Author, Author> authorMap = new HashMap<Author, Author>();
		authorMap.put(author2, author2);
	...
	public void testVerifyFirstNameA() {
		Author author1 = new Author("Kofia, Victro (UNIV TORONTO)",
				Category.INCITES);
		Author author2 = new Author("Kofia, Victor (UNIV TORONTO)",
				Category.INCITES);
		Author author3 = null;
		...
		author3 = authorMap.get(author1);
		if (author3 != null) {
			switched = !author3.getFirstName().equalsIgnoreCase(
	...
	public void testFacultyIdentificationInSetWhenIdentifierIsDefective() {
		...
		Author author1 = new Author("Kofia, Victo (UNIV TORONTO)",
				Category.INCITES, locmap);
		Author author2 = new Author("Kofia;Victor", Category.FACULTY);
		HashSet<Author> authorSet = new HashSet<Author>();
		authorSet.add(author2);
