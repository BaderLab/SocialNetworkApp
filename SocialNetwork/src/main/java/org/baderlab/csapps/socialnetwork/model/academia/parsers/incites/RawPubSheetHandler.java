...
/**
 * Handler for publications spreadsheet (SAX Parser) in a raw InCites
 * file
 *
 * @author Victor Kofia
 */
public class RawPubSheetHandler extends DefaultHandler {
     ...
     */
    public RawPubSheetHandler(SharedStringsTable sst, IncitesParser incitesParser) {
        this.sst = sst;
